...
author: 美团技术团队
source_url: "https://mp.weixin.qq.com/s/CTY5mdgKh6TmPrO6xsKhWQ"
date: 2026-05-07
tags: [AI Coding, 重构, 技术债, Agent评测, 工程实践, 美团]
---

# 用Agent评测思路管理AI Coding——31万行代码AI重构的实践

![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_001.gif)

> 当 90% 以上代码由 AI 生成，决定系统走向的不是谁写得更快，而是约束 AI 的能力。没有统一规范，AI 只会成倍放大混乱。本文基于 31 万行代码重构实践，分享如何用Agent 评测思路管理 AI Coding——通过技术债梳理、建设Rule、重构 SOP 和 Pre-PR 机制，把重构从高成本专项变成随迭代持续推进的日常动作。

## 核心经验

- **用评测 Agent 的方式管理 AI Coding**：先让人对齐（团队共识）→ 再让 AI 对齐（规范固化）。顺序错了，AI Rule 写得再好也是一纸空文。
- **AI 重新定义了"经验"的价值边界**：经验的价值正在从"能看全"转移到"能判断什么重要"——这才是人不可替代的部分。
- **技术债可以像业务需求一样被迭代消化**：重构不需要排期，需要拆解能力。把技术债拆解为业务需求的顺带动作。
- **工程师的角色变了**：从"写代码"转向"设计并维护一个能让 AI 可靠产出代码的工程环境"。

## 本文目录

- [一、背景](#一背景)
- [二、为什么要重构？](#二为什么要重构)
- [三、重构时间线与执行路径](#三重构时间线与执行路径)
  - 阶段一：定义问题，借助 AI 梳理技术债
  - 阶段二：调研并制定 AI 友好的研发规范
  - 阶段三：建立 SOP，"见缝插针"完成渐进式重构
- [四、总结](#四总结)

当团队 90% 以上的代码由 AI 生成，31 万行的复杂业务系统还在高速膨胀，你会发现一个反直觉的事实：AI Coding 不会自动收敛复杂度 —— 没有统一规范的约束，不同人用 AI 写出的代码风格各异，系统反而会加速腐化。

本文记录了我们如何在不停止业务交付的前提下，完成这场重构。
...
![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_002.png)
...
![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_003.png)
...
![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_004.png)
![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_005.png)
...
![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_006.png)
...
![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_009.png)
...
1. **用评测 Agent 的方式管理 AI Coding**：先"人人对齐"（团队统一共识）→ 再"人机对齐"（AI 可执行约束）。顺序错了，AI Rule 写得再好也是一纸空文。
2. **AI 重新定义了"经验"的价值边界**：AI 让所有人都能快速具备"看全"的能力。经验的价值正在从"能看全"转移到"能判断什么重要"——这才是人不可替代的部分。
3. **技术债可以像业务需求一样被迭代消化**：重构不需要排期，需要拆解能力。把技术债拆解为业务需求的顺带动作，在不停止业务交付的前提下渐进式消化。
4. **工程师的角色变了**：当 90% 代码由 AI 生成，团队成员的工作重心应从"写代码"转向"设计并维护一个能让 AI 可靠产出代码的工程环境"。

![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_010.png)

### 行动指南：如果你的团队也想落地

- **第一步**：盘清技术债。不要试图人工遍历，由核心开发圈定高危方向，让 AI 做穷举扫描。
- **第二步**：制定规范并落地为 AI Rule、Skill。先组织团队对齐核心共识，再将共识固化为 AI 编码时 always 加载的 Rule。
- **第三步**：由主 R 打样，沉淀可复用的迁移 SOP。先跑通一个模块的完整迁移流程，把步骤沉淀为 AI 可执行的 SOP，再推广到全组。
- **第四步**：建立 Pre-PR 机制。要求每次提交前先用 AI 按团队规范自查，过滤掉基础问题。

![Image](../assets/2026-05-07-Agent评测思路管理AI Coding/img_011.png)
